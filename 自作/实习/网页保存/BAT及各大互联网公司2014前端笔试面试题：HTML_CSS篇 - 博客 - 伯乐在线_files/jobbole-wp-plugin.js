...
jQuery(document).ready(function ($) {
    ...
    $('.login-container input#jb_user_login, .login-container input#jb_user_pass').enterKey(function () {
        ...
        jb_user_login($('#jb_user_login_btn'),user_login,user_pass,redirect_url);
    })
    ...
    $('#jb_user_login_btn').click(function(){
        ...
        jb_user_login($(this),user_login,user_pass,redirect_url);
    });
...
function jb_user_login(btn,user_login,user_pass,redirect_url){
...
function crawl_web_page(btn, source_url){
    if(source_url === ''){
        ...
        $('#crawl-article-submit-btn').text('发布文章');
