...
//   蛇形运动
  function shakeMove(arr,attr,start,targetr){
    var m = 0;
    var n = 0;
        var timer = null;
        timer = setInterval(function(){
        
        doMove(arr[m],attr,8,targetr,function(){
            
            doMove(arr[n],attr,8,start,function(){
                if(parseInt(getStyle(arr[0],attr)) == start){
              shakeMove(arr,attr,start,targetr); }
            })
            n++;
        })
          m++;
